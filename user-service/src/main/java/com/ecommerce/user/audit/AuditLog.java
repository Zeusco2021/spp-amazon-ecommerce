...
public class AuditLog {
    ...
    /** Nullable for failed login attempts where userId is unknown */
    private String userId;

    /** Action type: LOGIN_SUCCESS, LOGIN_FAILED, LOGOUT, USER_REGISTERED, etc. */
    @Column(nullable = false)
    private String action;

    /** Entity type: USER, ORDER, PAYMENT, PRODUCT */
    private String entityType;

    private String entityId;

    /** JSON string with extra contextual information */
